...
if __name__ == "__main__":
    ...
    executor.command.value = os.path.abspath("./face_detection-executor")
    executor.name = "Face Dectection Executor (Python)"
    executor.source = "python_test"

    framework = mesos_pb2.FrameworkInfo()
    framework.user = "" # Have Mesos fill in the current user.
    framework.name = "Face Detection Framework (Python)"
    ...
    if os.getenv("MESOS_AUTHENTICATE_FRAMEWORKS"):
        ...
        framework.principal = "face_detection-framework-python"
